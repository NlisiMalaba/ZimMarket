    ...
    <div className="rounded-2xl border border-border/70 bg-card p-6 shadow-sm">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Illustrative monthly curve seeded from today&apos;s revenue
          </p>
        </div>
        <div className="flex rounded-xl border border-border/80 bg-muted/30 p-1 text-xs font-medium">
          ...
          <span className="px-3 py-1.5 text-muted-foreground">Ops</span>
        </div>
      </div>
      ...
      <div className="mt-6 overflow-x-auto">
        ...
        >
          ...
          <path d={areaD} fill="url(#overview-fill)" />
          <path
            d={pathD}
            fill="none"
...
export function OpsMixDonut({
  ...
  const centerLabel = total > 0 ? `${Math.round(total)}` : "—";

  return (
    <div className="rounded-2xl border border-border/70 bg-card p-6 shadow-sm">
      <h2 className="text-lg font-semibold tracking-tight">Operational mix</h2>
      <p className="mt-1 text-sm text-muted-foreground">Shares of live dashboard totals</p>
...
export function MonthlyGoalCard({
  ...
  return (
    <div className="rounded-2xl border border-border/70 bg-card p-6 shadow-sm">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Today&apos;s progress toward an internal target ({formatter(target)})
      </p>
      <div className="mt-6">
